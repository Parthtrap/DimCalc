...
def getContours(img, cannyThresh=[100, 100], min_area=100, sides=0):
    img_canny = Outline(Grayscale(img), cannyThresh[0], cannyThresh[1])
    img_dilate = Dilate(img_canny, 3, 3, 1)
    img_eroded = Erode(img_dilate, 3, 3, 1)
